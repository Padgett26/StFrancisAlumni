...
<a href="#" onclick="showFeed('bboard')" style="text-decoration:none; color:<?php
...
echo $colordark?>; float:left; margin:0px;"><div style="margin-top:10px;">Global Bulletin Board</div></div></a>
...
echo $colordark?>; float:left; margin:0px;"><div style="margin-top:10px;">News Feed</div></div>

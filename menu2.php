...
echo <<<_END
</select><input type='submit' value='Go' style='border-radius:8px; -moz-border-radius:8px;' /></form></li>
...
echo "<li><a href='index.php?page=bboard' style='color:$colordark;'>My Bulletin Board</a></li>";
...
echo "<li><a href='index.php?page=modadmin' style='color:$colordark;'>";
if ($numapprove != "0" || $numcontact != "0" || $numreport != "0")
    echo "<b>$useryear Admin</b></a></li>";
else
    echo "$useryear Admin</a></li>";
echo <<<_END
